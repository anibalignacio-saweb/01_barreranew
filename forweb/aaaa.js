...
(function() {
    ...
    var PUZZLES_DIR = '/app/puzzles/';
    var logicURL = params.logic ? params.logic : '__LOGIC__/3d_app/app/visual_logic.js'.replace('__LOGIC__', '');
    var sceneURL = params.load ? params.load : '__URL__/3d_app/app/aaaa.gltf'.replace('__URL__', '');
    if (!sceneURL) {
