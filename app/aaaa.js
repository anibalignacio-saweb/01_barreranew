...
(function() {
    ...
    var logicURL = params.logic ? params.logic : '__LOGIC__app/visual_logic.js'.replace('__LOGIC__', '');
    var sceneURL = params.load ? params.load : '__URL__app/aaaa.gltf'.replace('__URL__', '');
    if (!sceneURL) {
